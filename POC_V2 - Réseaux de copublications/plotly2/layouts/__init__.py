                                ...
                                children=[
                                    html.Div(
                                        ...
                                        children=[
                                            ...
                                            dbc.Row(
                                                [
                                                    dbc.Col(dcc.Graph(id="sunburst_collab"), md=6),
                                                    dbc.Col(dcc.Graph(id="radar_centre"), md=6),
                                                ],
                                                className="mb-3",
                                            ),
                                            ...
                                            dbc.Row(
                                                [
                                                    dbc.Col(dcc.Graph(id="team_timeline"), md=7),
                                                    dbc.Col(dcc.Graph(id="sankey_collab"), md=5),
                                                ],
                                                className="mb-3",
                                            ),
